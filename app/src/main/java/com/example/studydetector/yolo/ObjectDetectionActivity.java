...
public class ObjectDetectionActivity extends com.example.studydetector.yolo.AbstractCameraXActivity<ObjectDetectionActivity.AnalysisResult> {
    private Module mModule = null;
    private com.example.studydetector.yolo.ResultView mResultView;
